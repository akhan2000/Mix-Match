...
struct Playlist: Identifiable {
    ...
    var songs: [Song] = []
    var coverUrl: URL?
    var mixedMatchedBy: String = ""
}

extension Playlist { //Lucas
    
    struct FormData{            //Lucas
        var name: String = ""
    } //end of FormData struct
...
extension User {
    static var previewData: [User] = [
        User(username: "cgg18", password: "test", name:"Christian Garvin", playlists: [
            Playlist(name: "Chill Country", songs:[
            ...
            Playlist(name: "Florida Rap", songs:[
            ...
            Playlist(name: "Alternative", songs:[
        ...
        User(username: "@DJlucas", password:"1", name: "Lucas Gibb", playlists: [
            Playlist(name: "EDM", songs:[
            ...
            Playlist(name: "Party Time", songs:[
                Song(id: "30", name: "Shape of You", artist: "Ed Sheeran", genre: "Pop", bpm: 96, popularity: 10, key: "D# minor"),
            ...
            Playlist(name: "Montana Music", songs:[
        ...
        User(username: "asfi", password: "levels", name: "Asfandyar", playlists: [
            Playlist(name: "Progressive House Music", songs:[
                Song(id: "8", name:"Democrats Rock (remix)", artist: "Bernie Sanders", genre: "EDM", bpm:120, popularity: 12, key:"major")]),
            Playlist(name: "Throwbacks", songs:[
            ...
            Playlist(name: "Chill House Music", songs:[
...
//      let recipe = User(name: formData.name)
//      return User.update(recipe, from: formData)
//    }
}

//here goes the huge library
extension Song {
    static let songLibrary: [Song] = [
        Song(id: "1", name:"Something in the Orange", artist: "Zach Bryan", genre: "Country", bpm:120, popularity: 12, key:"major"),
        Song(id: "2",name:"Feathered Indians", artist: "Tyler Childers", genre: "Country", bpm:120, popularity: 12, key:"major"),
        Song(id: "25", name:"Tequila Does", artist: "Miranda Lambert", genre: "Country", bpm:130, popularity: 10, key:"major"),
        Song(id: "26", name:"Whiskey Glasses", artist: "Morgan Wallen", genre: "Country", bpm:80, popularity: 8, key:"major"),
